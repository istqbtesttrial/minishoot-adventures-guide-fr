...
| Type | Nombre | À retenir |
| --- | ---: | --- |
| Modules purs | 17 | équipements / effets spéciaux importants |
| Skills | 4 | pouvoirs principaux : Boost, Dash, Supershot, Hover |
| Upgrades liés | 8 | upgrades classés dans le filtre “Modules & Skills” |
| Total filtre carte | 29 | ce que la carte regroupe sous “Modules & Skills” |

---

## ✨ Skills principaux

| Skill | Zone | Coordonnées | Objet interne |
| --- | --- | --- | --- |
...
| Module | Zone | Coordonnées | Objet interne |
| --- | --- | --- | --- |
...
## 🔫 Upgrades inclus dans “Modules & Skills”

| Upgrade | Zone | Coordonnées | Note |
| --- | --- | --- | --- |
...
## ✅ Checklist anti-oubli modules

- [ ] Family Home / maison familiale vérifiée
...
- [ ] Récompense finale des courses récupérée
...
- CSV : [`../data/map-extract/modules_and_skills.csv`](../data/map-extract/modules_and_skills.csv)
- JSON : [`../data/map-extract/modules_and_skills.json`](../data/map-extract/modules_and_skills.json)
- Ancienne page détaillée : [`modules.md`](modules.md)
